...
import withStorageHOCclass from './withStorageHOCclass';
...
const WrappedStorageComponent = withStorageHOCclass(ComponentNeedingStorage);

export default WrappedStorageComponent;